# -*- coding: utf-8 -*-
#
# datalad_dataverse documentation build configuration file, created by
...
project = u'Datalad Dataverse Extension'
copyright = u'2022-{}, DataLad team'.format(datetime.datetime.now().year)
author = u'DataLad team'

# The version info for the project you're documenting, acts as replacement for
# |version| and |release|, also used in various other places throughout the
# built documents.
version = datalad_dataverse.__version__
release = version
